...
The archive directory is `data/archive/`, next to the main journal file, auto-created.
The archive file name will be similar to the rules file, with a date added:
the original data file's modification date, or today's date if the data was command-generated.
