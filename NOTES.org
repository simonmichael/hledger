...
* about
Simon keeps developer notes in this emacs org-mode outline, NOTES.org.
Currently it contains my backlog, activity log, and random notes and only
I use this file, though anyone may send a patch.
** backlog
