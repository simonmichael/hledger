...
-- stack script --compile --resolver nightly-2026-04-17 --verbosity error --package hledger --package text
-- stack script --compile --resolver nightly-2026-04-17 --verbosity error --package hledger --package hledger-lib --package text --package safe
