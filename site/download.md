...
| Gentoo                         | **`sudo layman -a haskell && sudo emerge hledger hledger-ui hledger-web`** | [![](https://img.shields.io/badge/Gentoo_package-1.14.2-green.svg)](https://gentoo.zugaina.org/Search?search=hledger)
