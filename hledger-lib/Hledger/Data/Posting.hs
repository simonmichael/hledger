...
generatedTransactionTagName, modifiedTransactionTagName, costPostingTagName, conversionPostingTagName, generatedPostingTagName, splitPostingTagName, lotsplitPostingTagName, lotParentAssertionTagName :: TagName
...
splitPostingTagName         = "_split-posting"          -- a synthetic posting carved off an existing posting (eg by lot transfer auto-split); hidden by default in print
